...
describe('save_doc', () => {
  ...
  it('should allow to create a new document', () => {
  ...
  it('should NOT allow to create a document with the same name of an existing one', () => {
  ...
  it('should allow to update a document and NOT preserve properties of the old document', () => {
  ...
  it('should allow to update a document, requiring to pass the current _rev', () => {
    save_doc({ route: { method: 'POST' }, params: { db: 'people', doc: 'miko' }, body: { _rev: '12345', name: 'sanae', lastname: 'kochiya' } }, res, dummy_function);
    expect(mock_mock.databases.people.miko.name).toBe('sanae');
  });

  it('should NOT allow to update a document, if the _rev is wrong', () => {
  ...
  it('must return the id of the document it just created', () => {
  ...
  it('must return the id of the document it just updated', () => {
    save_doc({ route: { method: 'POST' }, params: { db: 'people', doc: 'miko' }, body: { _rev: '12345', name: 'sanae', lastname: 'kochiya' } }, res, dummy_function);
