...
describe('delete_doc', () => {
  ...
  it('should remove a document if you pass the correct _rev as a query parameter', () => {
  ...
  it('should remove a document if you pass the correct _rev as a if-match header', () => {
  ...
  it('must return the id of the document it just deleted', () => {
    del({ params: { db: 'people', doc: 'miko' }, query: {}, headers: { 'if-match': '"12345"' } }, res, dummy_function);
  ...
  it('should return a document update conflict error if the rev does not match', () => {
